# Segundo código: Número menor (mínimo 3 números)
...
main:
        ...
        li      $t4, 2147483647      # valor inicial para el número menor (el mayor valor posible)

input_loop:
        beq     $t3, $t0, find_min    # si ya se ingresaron todos los números, pasar a buscar el menor
        ...
        bgt     $t5, $t4, skip       # si el número ingresado es mayor que el menor, salta
        move    $t4, $t5             # si es menor, actualiza el valor del número menor
...
find_min:
        ...
        syscall                      # imprime "El número menor es: "
        
        # Imprimir el número menor
        move    $a0, $t4             # cargar el número menor en $a0
